...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vue = inflater.inflate(R.layout.fragment_main, container, false)
        return vue
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val stringRequest = StringRequest(
            ...
            Response.Listener<String> { response ->
                val obj = Gson().fromJson(response, Array<Game>::class.java);
                recyclerView.adapter = TextAdapter(object:IGame{
                    override fun open(game: Game) {
                        this@MainFragment.fragmentManager!!
                            .beginTransaction()
                            .addToBackStack(null)
                            .replace(R.id.fragment, GameDetailFragment(game)).commit();
                    }

                    override val games: Array<Game> = obj;
                });
